...
- `maxNumberOfTopLevelDescribes`: The maximum number of top-level `describe` blocks allowed in a file. Defaults to `Infinity`, which allows any number of top-level `describe` blocks.
