...
| [no-mock-implementation-throw](docs/rules/no-mock-implementation-throw.md)                                               | disallow mock implementations that only throw                                                   |     |       |     | 🔧  |     |     |     |
...
| [prefer-expect-type-of](docs/rules/prefer-expect-type-of.md)                                                             | enforce using `expect(...).toBeTypeOf(...)` instead of `expect(typeof ...).toBe(...)`           |     | 🌐    |     | 🔧  |     |     |     |
